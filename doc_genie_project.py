# -*- coding: utf-8 -*-
"""Doc Genie Project.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1I5aShb-WKyD2WjrPzgdHkFikqYaIICHB
"""
...
class DocGenieAnalyzer:
    ...
    @staticmethod
    def extract_function_signature(code):
        """Extract function name, parameters and return type using AST"""
    ...
    @staticmethod
    def analyze_function_logic(func_def, code):
        """Analyze AST nodes to understand function behavior"""
    ...
    def generate_google_docstring(signature, analysis, code):
        ...
        if signature["params"]:
            ...
            for p in signature["params"]:
                ...
                doc += f"        {p['name']} ({p['type']}): Parameter for controlling {p['name']}{default}.\n"

        doc += "\n    Returns:\n"
        doc += f"        {signature['return_type']}: Result of the computation.\n"
        doc += '    """\n'
    ...
    def generate_numpy_docstring(signature, analysis, code):
        ...
        if signature["params"]:
            ...
            for p in signature["params"]:
                doc += f"    {p['name']} : {p['type']}\n"
                doc += f"        Parameter controlling {p['name']}.\n"

        doc += "\n    Returns\n    -------\n"
        doc += f"    {signature['return_type']}\n"
        doc += "        Result of the computation.\n"
        doc += '    """\n'
...
class DocGenieAnalyzer:
    ...
    def analyze_function_logic(func_def, code):
        ...
        try:
            ...
            if func_def.name:
                description.append(f"Executes {func_def.name} operation")

            if analysis['has_conditions']:
                description.append("with conditional logic")

            if analysis['has_loops']:
                description.append("and iterates through values")

            if analysis['operations']:
                description.append("performing mathematical calculations")

            if analysis['has_return']:
                description.append("and returns the computed result")

            analysis['description'] = " ".join(description) + "."
            ...
            analysis['description'] = "Executes function logic based on parameters."
            return analysis
...
# ============================================================================
# GRADIO UI (UNCHANGED STYLING)
# ============================================================================

print("🚀 Loading Doc-Genie...")
...
with gr.Blocks(
    ...
    with gr.Row():
        ...
        with gr.Column(scale=3):
            ...
            docstring_style = gr.Radio(["google", "numpy"], value="google")
        ...
        with gr.Column(scale=1):
            ...
            file_upload = gr.File(file_types=['.py'])
